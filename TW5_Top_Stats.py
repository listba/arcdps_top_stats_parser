...
@Gooey(
	program_name="TW5 Top Stats",
	program_description="Reads a set of arcdps reports in json format and generates top stats",
	)

def main():
	parser = GooeyParser()
	parser.add_argument('input_directory', help='Directory containing .xml or .json files from arcdps reports', widget="DirChooser")
	...
	parser.add_argument('-c', '--config_file', dest="config_file", help="Config file with all the settings", default="TW5_parser_config_detailed", widget="FileChooser")
	parser.add_argument('-g', '--guild_data', dest="guild_data", help="Guild data file with API Keys", default="Guild_Data")
	...
	#guild_data = importlib.import_module(args.guild_data , package=None)
