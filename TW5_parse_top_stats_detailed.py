...
if __name__ == '__main__':
	...
	Header +="|!@@display:block;width:100px;Squad Data@@ |!@@display:block;width:100px;FightTime@@ | !@@display:block;width:115px;Incoming Clears@@ |"
	...
	Header +="|!@@display:block;width:100px;Group@@ | !@@display:block;width:100px;FightTime@@ | !@@display:block;width:115px;Incoming Clears@@ |"
	for key in TableKeys:
		Header += "!{{"+key+"}} |"
	Header +="h"
	myprint(output, Header)
	...
	Header +="|!@@display:block;width:50px;Prof@@ |!@@display:block;width:100px;Player@@ |!@@display:block;width:50px;Group@@ |!@@display:block;width:90px;FightTime@@ |"
	for key in TableKeys:
		Header += "!{{"+key+"}} |"
	Header +="h"
	myprint(output, Header)
